...
from scripts import load_to_tournaments
from scripts import x_apply_ratings
...
def run(*args):
        ...
        if(process_days_back is not None  and process_days_out is not None):
                print("30 - ", reset_string, str(ls_date), str(le_date),str(le_date_future))

                #force load from tables in case of reset is in the load_to_tournaments
                record_log_data(app_name, "load_to_tournaments", "Starting")
                load_to_tournaments.run(reset_string, ls_date_str, le_date_future_str)
                ...
                record_log_data(app_name, "x_apply_member_numbers", "Starting")
                x_apply_member_numbers.run(reset_string)
                record_log_data(app_name, "x_apply_member_numbers", "Completed")

                record_log_data(app_name, "x_apply_ratings", "Starting")
                x_apply_ratings.run(reset_string, ls_date_str, le_date_future_str)
                record_log_data(app_name, "x_apply_ratings", "Completec")
...
# python manage.py runscript workflow_daily_30_process
# nohup python manage.py runscript workflow_daily_30_process &

# python manage.py runscript workflow_daily_30_process --script-args reset
# nohup python manage.py runscript workflow_daily_30_process --script-args reset &



# python manage.py runscript workflow_daily_30_process --script-args 06/01/2024 11/12/2028
# python manage.py runscript workflow_daily_30_process --script-args reset 01/01/2022 04/30/2028

# python manage.py runscript workflow_daily_30_process --script-args reset 01/06/2022 01/31/2031 noload

# nohup python manage.py runscript workflow_daily_30_process --script-args reset 01/01/2022 01/31/2029 &
# nohup python manage.py runscript workflow_daily_30_process --script-args reset &

# nohup python manage.py runscript workflow_daily_30_process --script-args 06/01/2024 01/31/2029 noload &

# nohup python manage.py runscript workflow_daily_30_process --script-args 06/01/2024 01/31/2029 noload &

# python manage.py runscript workflow_daily_30_process --script-args 06/01/2024 01/31/2029 noload
